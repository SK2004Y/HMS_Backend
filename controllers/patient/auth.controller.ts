...
export const sendOTP = async (req: Request, res: Response) => {
  try {
    ...
    // Prepare SMS text
    const smsText = `Dears customer, your OTP for login is ${otp}. Please do not share this OTP with anyone. It is valid for 10 minutes. Regards YBLT Services Pvt Ltd`;
