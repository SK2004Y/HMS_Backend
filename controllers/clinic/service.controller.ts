...
//E_clinic service controller
export const createE_ClinicService = CatchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      console.log(`E_clinic body data `, req.body);
      ...
      const clinicService = new E_ClinicService(parsedBody);
      await clinicService.save();
